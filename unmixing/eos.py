...
cfmask_values = {
    ...
    'collection1': {
        ...
        'landsat8': {
            'low+': (1, 324, 328, 336, 352, 368, 386, 388, 392, 400, 416, 432, 480, 832, 836, 840, 848, 864, 880, 900, 904, 912, 928, 944, 992, 1024),
            'medium+': (1, 324, 328, 386, 388, 392, 400, 416, 432, 480, 832, 836, 840, 848, 864, 880, 900, 904, 912, 928, 944, 992, 1024)
        },
        # Landsat 4-7 Collection 1 pixel_qa values to be masked
        'landsat4-7': {
            'medium+': (1, 68, 72, 80, 112, 132, 136, 144, 160, 176, 224)
        }
    }
}
